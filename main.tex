...
% --- Link robusti e visibili ---
\usepackage{xurl} % link lunghi a capo
\PassOptionsToPackage{hyphens}{url}
% moderncv carica hyperref; setto le opzioni dopo il caricamento
\makeatletter
\@ifpackageloaded{hyperref}{%
  \hypersetup{
    colorlinks=true,
    linkcolor=black,      % titoli/ancore
    urlcolor=Maroon,      % come usi nel testo
    citecolor=Maroon,
    pdfauthor={Alessandro Sardone},
    pdftitle={CV - Alessandro Sardone}
  }
}{}
\makeatother

% Uniforma lo stile dei link testuali
\urlstyle{same}
